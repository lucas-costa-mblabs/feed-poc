            ...
            <div className="widget-section">
              ...
              <div className="widget-grid">
                ...
                <div
                  className="widget-item"
                  draggable="true"
                  onDragStart={(e) => onDragStart(e, "price")}
                >
                  <div className="widget-icon">
                    <svg
                      width="24"
                  ...
                  <div className="widget-name">Price</div>
                </div>
                <div
                  className="widget-item"
                  draggable="true"
                ...
                <div
                  className="widget-item"
                  draggable="true"
                  onDragStart={(e) => onDragStart(e, "post_interactions")}
                >
                  <div className="widget-icon">
                    <svg
                      width="24"
                  ...
                  <div className="widget-name">Post Interactions</div>
                </div>
              </div>
            </div>
